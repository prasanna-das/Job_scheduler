...
from .models import ChunkedUpload, BaseChunkedUpload
...
class ChunkedUploadCompleteView(ChunkedUploadBaseView):
    ...
    def _post(self, request, *args, **kwargs):
        ...
        chunked_upload.title = request.POST.get('name')
        chunked_upload.version = request.POST.get('version')
        chunked_upload.file_size = request.POST.get('size')
